        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-8">
            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">1. Acceptance of Terms</h2>
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">2. Platform Overview</h2>
              <p className="text-slate-600">
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">3. User Accounts</h2>
              <p className="text-slate-600">
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">4. Acceptable Use Policy</h2>
              <p className="text-slate-600">
              ...
              <ul className="list-disc space-y-2 ml-6 text-slate-600 marker:text-blue-600">
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">5. Intellectual Property</h2>
              <p className="text-slate-600">
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">6. Privacy and Data Protection</h2>
              <p className="text-slate-600">
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">7. Disclaimers and Limitations of Liability</h2>
              <p className="text-slate-600">
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">8. Indemnification</h2>
              <p className="text-slate-600">
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">9. Termination</h2>
              <p className="text-slate-600">
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">10. Governing Law and Dispute Resolution</h2>
              <p className="text-slate-600">
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">11. Changes to Terms</h2>
              <p className="text-slate-600">
            ...
            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">12. Contact Information</h2>
              <div className="prose max-w-none text-slate-600 space-y-4">
                <p>If you have any questions about these Terms of Service, please contact us at:</p>
                <p>Email: <a href="mailto:support@CareerToDo.com" className="text-blue-600 hover:underline">support@CareerToDo.com</a></p>
                <p>We will make reasonable efforts to respond to your inquiries in a timely manner.</p>
              </div>
            </section>

            <section className="bg-white/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent">13. General Provisions</h2>
              <p className="text-slate-600">
