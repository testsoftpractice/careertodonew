 ...
 * Uses Node.js packages (jsonwebtoken, bcryptjs)
 * SAFE for: API routes, server actions, server components
 * NOT SAFE for: Middleware (Edge runtime)
 */
 ...
 * Use verifyEdgeToken for middleware
 */
